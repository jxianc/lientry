  ...
  return (
    <div className="">
      ...
      <input
        {...field}
        {...props}
        className="my-1 w-full px-3 py-2 dark:bg-li-gray-1400 border border-li-gray-400 dark:border-li-gray-1100 placeholder-li-gray-700 focus:outline-none focus:border-li-green-main focus:z-10 text-xs md:text-sm rounded-[0.3rem]"
      />
